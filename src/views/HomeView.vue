<template>
  <!-- <div class="home">
      ...
      <h2 v-if="userStore.email">Email: {{ userStore.email }} </h2>
  </div> -->
  <div class="main">
     ...
     <header class="masthead text-center text-white">
      <div class="masthead-content">
        <div class="container px-5">
          ...
          <h2 class="masthead-subheading mb-0" v-if="userStore.email != ''"> {{ userStore.email }}</h2>
...
header.masthead {
  ...
  background: linear-gradient(90deg, rgba(180,142,0,1) 0%, rgba(179,2,172,1) 100%);
  background-repeat: no-repeat;
