<template>
  <section class="h-100 gradient-form backgroundPattern">
    <div class="container py-5 h-100 ext">
              ...
              <div class="card-body p-md-5 mx-md-4">
                ...
                <form @submit.prevent="authUser">
                  ...
                  <div class="form-outline mb-4">
                    <input type="email" id="email" class="form-control" placeholder="Correo electrónico" v-model="email"
                      required />
                  </div>
      ...
      <Popup v-if="bTriggerSuspendedAccountPopup">
        <div class="row">
          <div class="row">
            <div class="col-md-11">
              <h4 class="mt-2">Cuenta suspendida</h4>
            </div>
            <div class="col-md-1">
              <font-awesome-icon icon="fa-solid fa-xmark" class="float-end clickable" size="sm" style="color: #000000;"
                @click="bTriggerSuspendedAccountPopup = false" />
            </div>
            <p class="mt-2 fw-light">Esta cuenta ha sido suspendida por incumplir las normas de nuestra plataforma.</p>
          </div>
        </div>
      </Popup>
    </div>
