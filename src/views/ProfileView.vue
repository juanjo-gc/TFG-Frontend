              ...
              <div class="p-4 text-black" style="background-color: #f8f9fa">
                <div class="row mt-3">
                  <div class="col-2" v-if="person._iId != 0">
                    ...
                    <div class="row">
                      <div class="col-md-1">
                        <button type="button" class="btn btn-outline-danger mt-4 ms-2 "
                          v-if="userStore.person._iId != person._iId" @click="bTriggerReportPopup = true">
                            ...
                            <li v-for="post in aPosts">
                              <div class="media post-border m-2" v-if="post._tDeleteDate === null">
                                <div class="row">
                                  ...
                                  <div class="col-md-4" v-if="post._repliesTo != null"
                                    @click="router.push('/post/' + post._repliesTo._iId)">
                                  ...
                                  <div class="row">
                                    <div class="col-md-3">
                                      <button class="btn float-end" style="background-color: transparent;">
                                        <font-awesome-icon icon="fa-regular fa-comment" size="sm"
                                          style="color: #1e3050;" />
                                        0
                                      </button>
                                    </div>
